...
export function AttackGraph({ session }: Props) {
  ...
  // Need more than just the lone "attacker" node to show a useful graph
  ...
  return (
    <div className="border border-red-500/20 bg-red-500/5 rounded p-4 animate-fadeIn" ref={containerRef}>
      ...
      <div className="rounded overflow-hidden bg-[#060610] border border-[#1e1e2e]" style={{ minHeight: dimensions.height }}>
        <ForceGraph2D
          graphData={graphData}
